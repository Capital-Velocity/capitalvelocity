...
const Register = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Create an Account | Capital Velocity</title>
        <meta
          name="description"
          content="Sign up for a Capital Velocity account to access real estate funding tools, calculators, and partner loan opportunities. Start your journey today."
        />
        <link rel="canonical" href="https://www.capitalvelocity.com/register" />
          ...
          {`
    {
      ...
      "@type": "WebPage",
      "name": "Register",
      "url": "https://www.capitalvelocity.com/register",
      "description": "Create an account to access Capital Velocity’s real estate and business loan platform, including deal calculators, tools, and investor services.",
      "publisher": {
        "@type": "Organization",
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-br from-green-100 to-white transition-opacity duration-700 opacity-0 animate-fade-in-manual">
            <div className="bg-white shadow-xl rounded-2xl p-8 w-full max-w-md text-center">
              ...
              <p className="text-sm text-gray-600 mb-6">
                ...
                and notified when your account is ready for use. Please be on
                the lookout for an email regarding the status of your
                application!
              </p>
              <a
                href="/"
