...
export default function ForgotPassword() {
  ...
  return (
    <>
      <Helmet>
        <title>Forgot Password | Capital Velocity</title>
        <meta
          name="description"
          content="Reset your Capital Velocity account password. Enter your email to receive a secure link and regain access to your account."
        />
        <link
          rel="canonical"
          href="https://www.capitalvelocity.com/forgot-password"
        />
          ...
          {`
    {
      ...
      "url": "https://www.capitalvelocity.com/forgot-password",
      "description": "Use this page to reset your Capital Velocity account password securely by receiving a reset link via email.",
      "publisher": {
        "@type": "Organization",
