...
const FixandFlipCalcLoan = ({ formData, setFormData, fieldErrors }) => {
                ...
                <FormControl fullWidth>
                  ...
                  <TextField
                    ...
                    onChange={(e) => {
                      ...
                      setFormData((prev) => ({
                        ...prev,
                        propertyMonthlyPropertyTaxes: e.target.value,
                      }));
                    }}
                    InputProps={{
                      startAdornment: (
                ...
                <FormControl fullWidth>
                  ...
                  <TextField
                    ...
                    onChange={(e) => {
                      ...
                      setFormData((prev) => ({
                        ...prev,
                        propertyMonthlyInsurance: e.target.value,
                      }));
                    }}
                    InputProps={{
                      startAdornment: (
                ...
                <FormControl fullWidth>
                  ...
                  <TextField
                    ...
                    onChange={(e) => {
                      ...
                      setFormData((prev) => ({
                        ...prev,
                        propertyMonthlyUtilityBills: e.target.value,
                      }));
                    }}
                    InputProps={{
                      startAdornment: (
                ...
                <FormControl fullWidth>
                  ...
                  <TextField
                    ...
                    onChange={(e) => {
                      ...
                      setFormData((prev) => ({
                        ...prev,
                        propertyOtherMonthlyExpenses: e.target.value,
                      }));
                    }}
                    InputProps={{
                      startAdornment: (
...
export default FixandFlipCalcLoan;
