...
function PropertyInformationCashedOutRefinance({
  formData,
  setFormData,
  fieldErrors,
}) {
  ...
  const handleSliderChangeFicoScore = (event, newValue) => {
    setFormData({
      ...formData,
      ficoScore: newValue, // Use newValue instead of event.target.value
    });
  };
      ...
      <Container>
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12}>
            ...
            <div style={{ width: "100%" }}>
              <Slider
                value={formData.ficoScore || 600}
                onChange={handleSliderChangeFicoScore} // Use the corrected function
                min={600}
                max={800}
                step={20}
                marks={marksFico}
...
export default PropertyInformationCashedOutRefinance;
