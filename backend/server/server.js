...
// Railway provides PORT environment variable - use HTTP (Railway handles SSL)
...
// HTTP server - Railway/Vercel handle SSL automatically
...
const mg = mailgun({
    apiKey: process.env.MAILGUN_API_KEY || "032768b8a73ea019211af5bbf29108ef-3750a53b-d022c855",
    domain: process.env.MAILGUN_DOMAIN || "sandbox9bc8b50531c149729c9abf507ba74ca6.mailgun.org",
});
...
app.post("/api/forgot-password", async (req, res, next) => {
    ...
    // now we need to get the link from this token
                                    const link = `${process.env.FRONTEND_URL || 'https://capitalvelocity.com'}/reset-password/${user.id}/${token}`;
    console.log(link);
